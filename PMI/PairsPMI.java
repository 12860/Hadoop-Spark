...
public class PairsPMI extends Configured implements Tool {
  ...
  private static class PairsPMIReducer extends Reducer<PairOfStrings, IntWritable, PairOfStrings, DoubleWritable> {
    ...
    //private static double totalDocs = 98;
...
//      Path inFile = new Path(conf.get("intermediatePath"));
      ...
      Path inFile = new Path("/mid/part-r-00000");
  ...
  //private static final String my_libjars = "libjars";
  ...
  public int run(String[] args) throws Exception {
    ...
    //options.addOption(OptionBuilder.withArgName("path").hasArg()
      //  .withDescription("lib jars").create(my_libjars));
    ...
    int reduceTasks = cmdline.hasOption(NUM_REDUCERS) ? 
        ...
        //job2.setCombinerClass(PairsPMIReducer.class);
